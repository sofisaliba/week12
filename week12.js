...
const makeTen = () => {
	...
	resultTen.textContent = `Вторая буква: ${str[1]}`;
...
const makeEleven = () => {
	//Ваш код
	resultEleven.textContent = Math.abs(5, 2);
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	//Ваш код
	resultNineteen.textContent = str.substring(7, str.length);
};
